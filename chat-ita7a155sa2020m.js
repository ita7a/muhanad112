$('.checkbox label').html(`<input id="stealth" type="checkbox" value=""><img id="as13" src="/sico/1572134689532.png" width="70%" style="">`)



$(`<img src="/sico/1573415771152.png" class="fr" style="width:100%;margin-top: 1px;">
...
<b>
<font color="#78939C"> اداره  الموقع </font> </BR>
</BR>  MuHanad T7 </BR>
 </BR> للشكاوي والاستفسارات </BR>
<font color="#BF1D6E">Line:mudx999~Snap:muh.911</font></BR>     
`).insertBefore('.nav-tabs');
$("<a href=' ' target='_blank' class='fr btn btn-info fa fa-heart'>...... iTa7a.......</a>").insertAfter('.loginstat');
$(".label-primary").css("border-radius","24px 24px 24px 24px")
$(`<link href="https://fonts.googleapis.com/css?family=Changa" rel="stylesheet">
<marquee direction="right" width="65%" direction="right" style="margin-bottom: -7px;font-family: 'Changa', sans-serif; height: 20px;color:#FFF7AB;" onmouseover="this.stop()" onmouseout="this.start()" scrolldelay="0" scrollamount="5"> 🌸 اهلا وسهلا بكم .. في (شات التحليه للجوال) لمعاوده زيارتنا الكتابه في محركات البحث قوقل (شات التحليه) نتمنى لكم قضاء أجمل واسعد الاوقات
</marquee></font></b></td>
...
<img class="fl u-ico" alt="" src="/sico/1569974559772.gif">
<span style="padding: 1px 8px; margin-top: 2px; display: block; max-width: 82%; border-radius: 3px; color: rgb(199, 103, 48);" class="corner nosel u-topic dots fl hand">‎ WwW.iTa7a.CoM </span>
</div>
<br>
